    ...
    return (
        <div className='py-10'>
            <div className='h-full  flex-col w-full mx-auto flex justify-center relative items-center'>
                ...
                <div className='absolute   xl:right-32 right-10 text-right'>
                    <p className='lg"text-7xl md:text-5xl text-3xl text-blue-500 font-bold tracking-widest uppercase'>
                        sunglasses
                    </p>
                    <p className='uppercase lg:text-5xl text-3xl text-blue-300  lg:py-5 md:py-2 py-0'>
                        Supper Offer
                    </p>
                    <p className='lg:text-4xl text-2xl font-bold text-neutral-300'>
                        Acetate Frame Sunglasses
                    </p>
                    <p className='text-neutral-100 lg:py-5 md:py-2 py-0 lg:text-4xl font-extrabold'>
                        $40.00 Only
                    </p>
